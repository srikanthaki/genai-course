...
Week 1 · Section 1: Verify Your Environment
=============================================================================
...
HOW TO RUN:
  ...
  3. Run:  python week1_section1_environment.py
=============================================================================
"""
...
def check_python_version() -> bool:
    ...
    We'll learn type hints properly in Part 2 (Sunday).
...
def check_packages() -> bool:
    """
    Checks that the three libraries we need for this course are installed.
